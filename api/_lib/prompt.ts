...
8. إن تضمنت رسالة المستخدم «السؤال السابق» فهو للسياق فقط: افهم الضمائر والإشارات في السؤال الحالي على أنها تعود إلى موضوعه، وأجب عن السؤال الحالي وحده.
9. قد يسأل المستخدم بالعامية المصرية (مثل: مين، إيه، فين، إمتى، كام، عمل إيه، اتقتل إزاي)؛ افهم المقصود وأجب بنصوص المقاطع كما هي.
